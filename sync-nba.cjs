// sync-nba.cjs — Mise à jour au 10 mai 2026
...
function getAllGames() {
  return [
    ...
    // ── EST : NYK vs PHI — NYK mène 3-0 ──
    { id: 'g_sf_nyk1', serie_id: 'NYK_PHI', conf: 'EST', game_num: 1, home: 'NYK', away: 'PHI', home_name: 'New York Knicks', away_name: 'Philadelphia 76ers', game_date: '2026-05-05T00:00:00Z', status: 'finished', home_score: 137, away_score: 98,  serie_record: 'NYK mène 3-0', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_nyk2', serie_id: 'NYK_PHI', conf: 'EST', game_num: 2, home: 'NYK', away: 'PHI', home_name: 'New York Knicks', away_name: 'Philadelphia 76ers', game_date: '2026-05-06T23:00:00Z', status: 'finished', home_score: 108, away_score: 102, serie_record: 'NYK mène 3-0', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_nyk3', serie_id: 'NYK_PHI', conf: 'EST', game_num: 3, home: 'PHI', away: 'NYK', home_name: 'Philadelphia 76ers', away_name: 'New York Knicks', game_date: '2026-05-08T23:00:00Z', status: 'finished', home_score: 94,  away_score: 108, serie_record: 'NYK mène 3-0', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_nyk4', serie_id: 'NYK_PHI', conf: 'EST', game_num: 4, home: 'PHI', away: 'NYK', home_name: 'Philadelphia 76ers', away_name: 'New York Knicks', game_date: '2026-05-10T19:30:00Z', status: 'upcoming', home_score: null, away_score: null, serie_record: 'NYK mène 3-0', win_prob_home: 47.5, win_prob_away: 52.5 },

    // ── EST : DET vs CLE — DET mène 2-1 ──
    { id: 'g_sf_det1', serie_id: 'DET_CLE', conf: 'EST', game_num: 1, home: 'DET', away: 'CLE', home_name: 'Detroit Pistons', away_name: 'Cleveland Cavaliers', game_date: '2026-05-05T23:00:00Z', status: 'finished', home_score: 111, away_score: 101, serie_record: 'DET mène 2-1', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_det2', serie_id: 'DET_CLE', conf: 'EST', game_num: 2, home: 'DET', away: 'CLE', home_name: 'Detroit Pistons', away_name: 'Cleveland Cavaliers', game_date: '2026-05-07T23:00:00Z', status: 'finished', home_score: 107, away_score: 97,  serie_record: 'DET mène 2-1', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_det3', serie_id: 'DET_CLE', conf: 'EST', game_num: 3, home: 'CLE', away: 'DET', home_name: 'Cleveland Cavaliers', away_name: 'Detroit Pistons', game_date: '2026-05-09T19:00:00Z', status: 'finished', home_score: 116, away_score: 109, serie_record: 'DET mène 2-1', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_det4', serie_id: 'DET_CLE', conf: 'EST', game_num: 4, home: 'CLE', away: 'DET', home_name: 'Cleveland Cavaliers', away_name: 'Detroit Pistons', game_date: '2026-05-12T00:00:00Z', status: 'upcoming', home_score: null, away_score: null, serie_record: 'DET mène 2-1', win_prob_home: 59.2, win_prob_away: 40.8 },

    // ── OUEST : SAS vs MIN — SAS mène 2-1 ──
    { id: 'g_sf_sas1', serie_id: 'SAS_MIN', conf: 'OUEST', game_num: 1, home: 'SAS', away: 'MIN', home_name: 'San Antonio Spurs', away_name: 'Minnesota T-Wolves', game_date: '2026-05-05T01:30:00Z', status: 'finished', home_score: 102, away_score: 104, serie_record: 'SAS mène 2-1', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_sas2', serie_id: 'SAS_MIN', conf: 'OUEST', game_num: 2, home: 'SAS', away: 'MIN', home_name: 'San Antonio Spurs', away_name: 'Minnesota T-Wolves', game_date: '2026-05-07T01:30:00Z', status: 'finished', home_score: 133, away_score: 95,  serie_record: 'SAS mène 2-1', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_sas3', serie_id: 'SAS_MIN', conf: 'OUEST', game_num: 3, home: 'MIN', away: 'SAS', home_name: 'Minnesota T-Wolves', away_name: 'San Antonio Spurs', game_date: '2026-05-09T01:30:00Z', status: 'finished', home_score: 108, away_score: 115, serie_record: 'SAS mène 2-1', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_sas4', serie_id: 'SAS_MIN', conf: 'OUEST', game_num: 4, home: 'MIN', away: 'SAS', home_name: 'Minnesota T-Wolves', away_name: 'San Antonio Spurs', game_date: '2026-05-10T23:30:00Z', status: 'upcoming', home_score: null, away_score: null, serie_record: 'SAS mène 2-1', win_prob_home: 37.6, win_prob_away: 62.4 },

    // ── OUEST : OKC vs LAL — OKC mène 3-0 ──
    { id: 'g_sf_okc1', serie_id: 'OKC_LAL', conf: 'OUEST', game_num: 1, home: 'OKC', away: 'LAL', home_name: 'OKC Thunder', away_name: 'Los Angeles Lakers', game_date: '2026-05-06T00:30:00Z', status: 'finished', home_score: 108, away_score: 90,  serie_record: 'OKC mène 3-0', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_okc2', serie_id: 'OKC_LAL', conf: 'OUEST', game_num: 2, home: 'OKC', away: 'LAL', home_name: 'OKC Thunder', away_name: 'Los Angeles Lakers', game_date: '2026-05-08T01:30:00Z', status: 'finished', home_score: 125, away_score: 107, serie_record: 'OKC mène 3-0', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_okc3', serie_id: 'OKC_LAL', conf: 'OUEST', game_num: 3, home: 'LAL', away: 'OKC', home_name: 'Los Angeles Lakers', away_name: 'OKC Thunder', game_date: '2026-05-10T00:30:00Z', status: 'finished', home_score: 108, away_score: 131, serie_record: 'OKC mène 3-0', win_prob_home: null, win_prob_away: null },
    { id: 'g_sf_okc4', serie_id: 'OKC_LAL', conf: 'OUEST', game_num: 4, home: 'LAL', away: 'OKC', home_name: 'Los Angeles Lakers', away_name: 'OKC Thunder', game_date: '2026-05-12T02:30:00Z', status: 'upcoming', home_score: null, away_score: null, serie_record: 'OKC mène 3-0', win_prob_home: 18.3, win_prob_away: 81.7 },
  ];
}

async function sync() {
  console.log('🏀 Synchronisation NBA Playoffs — 10 mai 2026\n');
